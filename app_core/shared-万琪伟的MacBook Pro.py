...
APP_VERSION = "P7.1-pose-laser-serial-fix"
...
class SystemConfig:
    ...
    hardware_imu_enabled: bool = False
    hardware_imu_auto_connect: bool = False
    hardware_imu_port: str = ''
    hardware_imu_baudrate: int = 115200
    hardware_laser_stream_enabled: bool = False
    hardware_laser_stream_auto_connect: bool = False
